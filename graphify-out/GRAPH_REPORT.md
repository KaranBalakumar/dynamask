...
## Corpus Check
- 1665 files · ~404,392,542 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6436 nodes · 10660 edges · 181 communities detected
...
- `A matcher that returns ground truth optical flow.          Will raise AssertionE` --uses--> `TartanStereoVOMatch`  [INFERRED]
  dynamask_vio/references/MAC-VO/Module/Frontend/Matching.py → dynamask_vio/references/MAC-VO/Module/Network/TartanVOStereo/StereoVO_Interface.py
- `Use FlowFormer to estimate optical flow betweeen two frames. Does not generate m` --uses--> `TartanStereoVOMatch`  [INFERRED]
  dynamask_vio/references/MAC-VO/Module/Frontend/Matching.py → dynamask_vio/references/MAC-VO/Module/Network/TartanVOStereo/StereoVO_Interface.py
- `Use the modified FlowFormer proposed by us to jointly estimate optical flow betw` --uses--> `TartanStereoVOMatch`  [INFERRED]
  dynamask_vio/references/MAC-VO/Module/Frontend/Matching.py → dynamask_vio/references/MAC-VO/Module/Network/TartanVOStereo/StereoVO_Interface.py
- `Use TartanVO to estimate optical flow between two frames.` --uses--> `TartanStereoVOMatch`  [INFERRED]
  dynamask_vio/references/MAC-VO/Module/Frontend/Matching.py → dynamask_vio/references/MAC-VO/Module/Network/TartanVOStereo/StereoVO_Interface.py
- `Use a modified version of TartanVO frontend network to jointly estimate optical` --uses--> `TartanStereoVOMatch`  [INFERRED]
  dynamask_vio/references/MAC-VO/Module/Frontend/Matching.py → dynamask_vio/references/MAC-VO/Module/Network/TartanVOStereo/StereoVO_Interface.py
...
Cohesion: 0.01
Nodes (171): main(), sample(), main(), sample(), main(), sample(), main(), sample() (+163 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (136): BayerOutputFormat(), DebayerVideo(), DownsampleDebayer(), GrabNewest(), GrabNext(), PitchedImageCopy(), ProcessImage(), ProcessStreams() (+128 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (123): cast(), localtime_thread_safe(), deprecated_call(), pytest.deprecated_call() seems broken in pytest<3.9.x; concretely, it     doesn', # TODO: Remove this when testing requires pytest>=3.9., bind_ConstructorStats(), PYBIND11_MODULE(), get_await_result() (+115 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (147): ABC, TartanVO, ConfigTestableSubclass, Plots Gaussian distribution for some confidence interval and compare the  predic, CUDAGraph_FlowFormerCovFrontend, CUDAGraphHandler, estimate_depth(), estimate_pair() (+139 more)
...
Cohesion: 0.01
Nodes (81): AppendColumns(), ReadRow(), SkipLines(), GetKeyModifierBitmask(), key_callback(), mod_key(), mouse_callback(), spec_key() (+73 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (112): PSMNet, Chain, To have SML-like function chaining operator      (f1 >> f2)(x) = f2(f1(x)), get_cmake_dir(), get_include(), Return the path to the pybind11 CMake module directory., Return the path to the pybind11 include directory. The historical "user"     arg, ConfigTestable (+104 more)

### Community 7 - "Community 7"
Cohesion: 0.01
Nodes (93): CasADIEKF, CasADIMU, EKF_runner, main(), TqdmProgress, IMUEKF, r'''     Performs Batched Extended Kalman Filter (EKF).      Args:         model, r'''         Set the covariance matrices of transition noise and observation noi (+85 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (91): BlackBird, Reference: https://github.com/uzh-rpg/learned_inertial_model_odometry/blob/maste, Updates the data (imu / velocity) based on the required mode.         :param coo, Sets the ground truth orientation based on the provided rotation.         :param, broadcast_inputs(), check_broadcastable(), Automatic broadcasting of missing dimensions, convert_bag() (+83 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (78): Expand(), FileExists(), FilesMatchingWildcard(), FindPath(), MakeUniqueFilename(), MatchesWildcard(), PathExpand(), PathOsNormaliseInplace() (+70 more)
...
Cohesion: 0.02
Nodes (101): GlobalConfig, Capture, doc(), gc_collect(), _make_explanation(), msg(), Output, pytest_assertrepr_compare() (+93 more)

### Community 13 - "Community 13"
Cohesion: 0.01
Nodes (59): ba(), block_matmul(), block_solve(), CholeskySolver, disp_retr(), pose_retr(), block matrix multiply, safe_scatter_add_mat() (+51 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (54): DeepPatchVO, # NOTE: DPVO will perform /255 operation internally., GatedResidual, GradClip, GradientClip, GradientZero, GradMag, GradZero (+46 more)

### Community 15 - "Community 15"
Cohesion: 0.02
Nodes (82): PThreadConditionVariable, ConfigureColorNode(), ConfigureDepthNode(), ConfigureNodes(), DepthSenseContext(), DepthSenseVideo(), DeviceClosing(), EventLoop() (+74 more)
...
Cohesion: 0.02
Nodes (54): changeStructure(), loadFeatures(), main(), testDatabase(), testVocCreation(), wait(), HighestPriScheme(), PrintFactoryDetails() (+46 more)
...
Cohesion: 0.03
Nodes (64): AirIMUCorrector, _assert_airimu_load_clean(), CNNEncoder, load_airimu_weights(), AirIMU CodeNet-compatible IMU correction module.  This module mirrors the core A, Broadcast interval-wise features back to per-sample sequence slots., 1D CNN encoder used by AirIMU CodeNet., Fail loudly on suspicious state-dict mismatches. (+56 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (64): AddLine(), CommonPrefix(), ConsoleView(), DrawLine(), GetLine(), glColour(), IsShown(), Keyboard() (+56 more)

### Community 21 - "Community 21"
Cohesion: 0.03
Nodes (41): _append_jsonl(), OfflineDebugCallback, OfflineModelWatchCallback, OfflineWriter, Offline debug logging callbacks for DynaMask V2.  These callbacks mirror the W&B, Offline equivalent of WandbDebugCallback with parity metric names., Append-only writer for offline training debug artifacts., Offline equivalent of wandb.watch periodic parameter/gradient snapshots. (+33 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (41): array_copy_but_one(), assert_equal_ref(), assert_keeps_alive(), assert_sparse_equal_ref(), assign_both(), get_elem(), Eigen doesn't support (as of yet) negative strides. When a function takes an Eig, Tests various ways of returning references and non-referencing copies (+33 more)
...
Cohesion: 0.06
Nodes (23): connect(), connect_scoped(), connection, connection_blocker, copy_on_write, disconnect(), disconnect_if(), get_function_ptr() (+15 more)
...
Cohesion: 0.1
Nodes (18): clear_instance(), deregister_instance(), enable_buffer_protocol(), enable_dynamic_attributes(), get_fully_qualified_tp_name(), make_default_metaclass(), make_new_instance(), make_new_python_type() (+10 more)
...
## Knowledge Gaps
- **543 isolated node(s):** `Evaluation: mask quality metrics + VIO trajectory metrics.  Mask metrics (on VIO`, `Compute IoU, Precision, Recall, F1 for a batch.      Args:         pred_mask: [B`, `Evaluate mask quality over a full dataloader.`, `Evaluate IMU preintegration quality (RTE, ROE).`, `Compute ATE RMSE and RPE using the evo package.      Args:         est_traj_file` (+538 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 79`** (2 nodes): `addPoshVcpkgToPowershellProfile.ps1`, `findExistingImportModuleDirectives()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (2 nodes): `deploy-windows-sdks.ps1`, `InstallWindowsDK()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (2 nodes): `create-image.ps1`, `Invoke-ScriptWithPrefix()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (2 nodes): `deploy-mpi.ps1`, `InstallMpi()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (2 nodes): `deploy-install-disk.ps1`, `New-PhysicalDisk()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (2 nodes): `deploy-inteloneapi.ps1`, `InstallInteloneAPI()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (2 nodes): `disk-space.ps1`, `Format-Size()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (2 nodes): `deploy-visual-studio.ps1`, `InstallVisualStudio()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (2 nodes): `qtdeploy.ps1`, `deployPluginsIfQt()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `openni2deploy.ps1`, `deployOpenNI2()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (2 nodes): `check_getcontext.cc`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (2 nodes): `gettimeofday.h`, `gettimeofday()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (2 nodes): `magnumdeploy.ps1`, `deployPluginsIfMagnum()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (2 nodes): `decomp.c`, `set_endian()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (2 nodes): `generateFeatures.ps1`, `GetDescription()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (2 nodes): `k4adeploy.ps1`, `deployAzureKinectSensorSDK()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (2 nodes): `Optimization_Ablation.py`, `run_frame()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (2 nodes): `test_config_tartanvo.py`, `test_tartanvo_config()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (2 nodes): `test_config_macvo.py`, `test_macvo_config()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (2 nodes): `test_config_sequence.py`, `test_sequence_cfg()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (2 nodes): `test_performance_macvo.py`, `test_macvo_performance()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (2 nodes): `test_stereo_depth.py`, `test_matching()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (2 nodes): `test_config_loadable.py`, `test_config_loadable()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `test_matching.py`, `test_matching()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (2 nodes): `test_frontend.py`, `test_frontend()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (2 nodes): `Experiment_DPVO.py`, `execute_experiment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `Experiment_MACVO.py`, `execute_experiment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `Experiment_TartanVO.py`, `execute_experiment()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `MatchEstimator.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (2 nodes): `TartanVODisparity_AvgError.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 109`** (2 nodes): `submission.py`, `get_cfg()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 110`** (1 nodes): `chartdir.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (1 nodes): `Solve H x = b via Cholesky decomposition.          Args:             H: [B, 6, 6`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 112`** (1 nodes): `The CXX standard level. If set, will add the required flags. If left         at`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `make_changelog.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (1 nodes): `libsize.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (1 nodes): `test_eval_call.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (1 nodes): `The CXX standard level. If set, will add the required flags. If left         at`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 117`** (1 nodes): `X11GlContext.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `symbol_helper.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (1 nodes): `dummy.cpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 120`** (1 nodes): `bootstrap.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 121`** (1 nodes): `test-modified-ports.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 122`** (1 nodes): `Create-PRDiff.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 123`** (1 nodes): `drop-to-admin-user-prefix.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (1 nodes): `provision-entire-image.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 125`** (1 nodes): `sysprep.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 126`** (1 nodes): `deploy-pwsh.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 127`** (1 nodes): `deploy-cuda.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 128`** (1 nodes): `deploy-psexec.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 129`** (1 nodes): `create-vmss.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 130`** (1 nodes): `Install-Prerequisites.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 131`** (1 nodes): `Setup-VagrantMachines.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 132`** (1 nodes): `Vagrantfile-vm.rb`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 133`** (1 nodes): `Vagrantfile-box.rb`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 134`** (1 nodes): `rearrange-msvc-drop-layout.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 135`** (1 nodes): `arith_osx.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 136`** (1 nodes): `arith_win64.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 137`** (1 nodes): `arith_win32.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 138`** (1 nodes): `angle_commit.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 139`** (1 nodes): `convert_lib_params_linux.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 140`** (1 nodes): `generate_static_link_cmd_linux.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 141`** (1 nodes): `generate_static_link_cmd_windows.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 142`** (1 nodes): `generate_static_link_cmd_macos.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 143`** (1 nodes): `convert_lib_params_macos.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 144`** (1 nodes): `convert_lib_params_windows.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 145`** (1 nodes): `cgnsconfig.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 146`** (1 nodes): `fficonfig.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 147`** (1 nodes): `modp_b64_data.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 148`** (1 nodes): `libsecp256k1-config.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 149`** (1 nodes): `openblas_common.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 150`** (1 nodes): `config.linux.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 151`** (1 nodes): `arith_linux64.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 152`** (1 nodes): `magick_types.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 153`** (1 nodes): `b64_static_config.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 154`** (1 nodes): `b64_dynamic_config.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 155`** (1 nodes): `u2f-server-version.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 156`** (1 nodes): `FreeImageConfig-static.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 157`** (1 nodes): `FreeImageConfig-dynamic.h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 158`** (1 nodes): `The CXX standard level. If set, will add the required flags. If left at`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 159`** (1 nodes): `Assign a short name for the dataset class. By default will be the class name.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 160`** (1 nodes): ``is_valid_config`                  This method is for minimum sanity check on co`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 161`** (1 nodes): `A default collate function that will handle torch.Tensor, pp.LieTensor and`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 162`** (1 nodes): `MatchQuality.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 163`** (1 nodes): `DepthQuality.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 164`** (1 nodes): `TartanVO.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 165`** (1 nodes): `Given a batch of N observation (`TensorBundle`), the filter returns a boolean te`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 166`** (1 nodes): `Given a sequence of frames, elaborate the trajectory (frame poses) and handle th`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 167`** (1 nodes): `Given config, initialize a *mutable* context object that is preserved between op`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 168`** (1 nodes): `Given context and argument, construct the optimization problem, solve it and ret`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 169`** (1 nodes): `Returns immediately, indicate the status of optimizer:         - true if there`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 170`** (1 nodes): `Returns the concrete type used for T_GraphInput. Raises TypeError if not explici`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 171`** (1 nodes): `Returns the concrete type used for T_GraphOutput. Raises TypeError if not explic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 172`** (1 nodes): `This function should be implemented by the user.         It should return the ja`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 173`** (1 nodes): `Returns the jacobian of the model's previous forward call with respect to model'`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 174`** (1 nodes): `Verifies whether the input J_analytic coincides with autograd jacobian of the pr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 175`** (1 nodes): `Given a pixel_uv (Nx2) tensor, retrieve the pixel values (1, N) from scalar_map`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 176`** (1 nodes): `r'''         Linear/linearized system output matrix.          .. math::`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 177`** (1 nodes): `r'''         Linear/Linearized system observation matrix.          .. math::`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 178`** (1 nodes): `r'''         The covariance of system transition noise.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 179`** (1 nodes): `r'''         The covariance of system transition noise.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 180`** (1 nodes): `r'''         The covariance of system observation noise.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Timer` connect `Community 3` to `Community 1`, `Community 25`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `TartanStereoVOMatch` connect `Community 12` to `Community 3`?**
